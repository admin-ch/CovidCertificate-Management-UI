...
describe('UnitSearchComponent', () => {
	...
	describe('isAllSelected', () => {
		it('should return true', () => {
			...
			selectedProfilesService.add(...users)

			expect(component.isAllSelected(new MatTableDataSource<EiamProfile>(users))).toBe(true)
		});
		it('should return false', () => {
			...
			selectedProfilesService.add(...users.filter((user, index) => index === 0))

			expect(component.isAllSelected(new MatTableDataSource<EiamProfile>(users))).toBe(false)
		});
	});
	...
	describe('isSomeSelected', () => {
		it('should return false', () => {
			...
			selectedProfilesService.clear()

			expect(component.isSomeSelected(new MatTableDataSource<EiamProfile>(users))).toBe(false)
		});
		it('should return true', () => {
			const users: EiamProfile[] = [
				{
			...
			expect(component.isSomeSelected(new MatTableDataSource<EiamProfile>(users))).toBe(true)
		});
	});
