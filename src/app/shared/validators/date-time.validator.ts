 ...
 * @returns null
 */
export const getStartDateBeforeEndDateValidator: (startDateControlName: string, endDateControlName) => ValidatorFn = (startDateControlName: string, endDateControlName: string) => (control: AbstractControl) => {
 ...
 * @returns null
 */
export const getMaxPeriodValidator: (startDateControlName: string, endDateControlName: string, maxPeriodInDays: number) => ValidatorFn = (startDateControlName: string, endDateControlName: string, maxPeriodInDays: number) => (control: AbstractControl) => {
	// Safety checks
	if (!validateBothDatesAvailable(control, startDateControlName, endDateControlName)) {
		return null
	}
...
const validateBothDatesAvailable = (control: AbstractControl, startDateControlName: string, endDateControlName: string) => {
